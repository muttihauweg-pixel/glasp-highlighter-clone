...
async def process_input(request: ProcessRequest):
    ...
    try:
        ...
        # 2. Advanced Parsing for Demo
        # Use regex to find RISK: and RATIONALE: from the model's output
        ...
        result = {
            ...
            "processed_output": f"Audit-ready execution of request: {user_input[:50]}..."
        }

        # 3. Enhanced Audit Trail
        timestamp = datetime.datetime.now().isoformat()
        # Include image data in hash if present
