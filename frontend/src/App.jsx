  ...
  return (
    <div className="container">
      <header>
        ...
        <p style={{color: "#94a3b8", marginTop: "-1rem"}}>Autonomous EU AI Act Compliance Engine</p>
      </header>
      ...
      {loading && (
        <div className="loading-state">
          ...
          <p>Gemini 1.5 Pro is analyzing regulatory alignment...</p>
        </div>
      )}
